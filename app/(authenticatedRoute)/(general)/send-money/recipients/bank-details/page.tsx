      ...
      <div className="my-7 relative bg-white rounded-lg mx-auto ">
        ...
        <div className="relative">
          ...
          <div className="max-w-xl mx-auto relative">
            <p className="text-sm font-dm-sans pb-2 text-gray-500 font-medium">
            ...
            <div className="space-y-2">
              <div>
                ...
                <select
                  name=""
                  id=""
                  className="rounded-md text-sm border-[#072032] font-poppins p-2 border w-full mt-1"
                >
              ...
              <div>
                ...
                <input
                  type="text"
                  className="rounded-md border-[#072032] p-2 border w-full mt-1 text-sm font-poppins active:border-[#072032]"
                />
              </div>{" "}
              <div>
                <label
              ...
              <div>
                ...
                <textarea
                  placeholder="Purpose"
                  className="rounded-md font-poppins text-sm h-[100px] border-[#072032] p-2 border w-full mt-1"
                />
              </div>
