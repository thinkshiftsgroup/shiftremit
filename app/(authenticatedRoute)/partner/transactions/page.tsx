                            ...
                            <div className="flex items-center justify-between gap-2 py-3 px-3">
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <p className="font-bold">John Israel</p>
                    ...
                    <div className="py-3.5 bg-white my-4 w-full md:w-4/10 lg:w-3/10 space-y-3 border-l md:border-0 ps-3">
                        ...
                        <div className="border rounded space-y-3 p-3">
                            <div className="flex justify-between items-start">
                                <span className="text-gray-600 text-sm text-medium">Transaction ID</span>
                                <span className="text-black font-semibold text-sm text-right">#EXEPVA6SFG7FLDT</span>
                            </div>
                            <div className="flex justify-between items-start">
                                <span className="text-gray-600 text-sm text-medium">Date</span>
                                <span className="text-black font-semibold text-sm">03 Nov 2025</span>
                            </div>
                            <div className="flex justify-between items-start">
                                <span className="text-gray-600 text-sm text-medium">Status</span>
                                <span className="p-1 rounded-xs flex bg-[#e8f7eb] text-xs">Completed</span>
                                {/* <span className="px-4 py-2 bg-green-100 text-green-800 rounded-full font-medium text-sm">
                                    Completed
                                </span> */}
                            </div>
                            <div className="flex justify-between items-start">
                                <span className="text-gray-600 text-sm text-medium">Recipient</span>
                                <span className="text-black font-semibold text-sm">NGN343,056.00</span>
                            </div>
                        </div>
                    </div>
                </div>
