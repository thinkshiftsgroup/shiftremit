...
const PaymentSwiper = () => {
  ...
  const amounts = [
    100, 250, 500, 750, 1000, 1250, 1500, 1750, 2000, 2250, 2500, 2750, 3000,
    3500, 4000, 4500, 5000, 6000, 7000, 7500, 8000, 9000, 10000, 12000, 15000,
    18000, 20000, 25000, 30000, 40000, 50000, 75000, 100000,
  ];
  const tags = [
    "#rent",
    "#fee",
